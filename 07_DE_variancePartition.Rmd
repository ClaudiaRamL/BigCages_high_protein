...
Here the replicate specific transcriptomic response of each evolved replicates
is modeled. We use 3 samples per replicate, each sub-replicate generated during 2 generations
of Common Garden Experiment.
...
DE_repbyrep_3_contrasts_results <- rbind(all_DE_results_R1, all_DE_results_R2, all_DE_results_R3, all_DE_results_R4, all_DE_results_R5, all_DE_results_R6)
# Remove per group adjusted val:
...
write_csv(export_df,"input_files/DE_repwise_results.csv")
...
display_venn(x,
  category.names = c("Overall-model" , "Replicate-wise models"),
