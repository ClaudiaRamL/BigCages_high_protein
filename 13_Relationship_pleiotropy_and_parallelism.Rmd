...
combined_conn_rep_wise_parallel_df <- combined_conn_rep_wise_parallel_df %>%
  mutate(significance = case_when(
    ...
    padj_fdr < 0.0001 ~ "****"))
combined_conn_rep_wise_parallel_df$padj_Bonferroni <- format(combined_conn_rep_wise_parallel_df$padj_Bonferroni, scientific = TRUE, digits = 2)
# Export test results:
...
#write_xlsx(export_df, "output_files/S7_wilcox_test_pleiotropy_and_parallellism")
