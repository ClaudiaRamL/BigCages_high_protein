...
Including contrasts: Base vs evolved replicate.
All replicates were compared to base independently in each generation.
Each replicated had 3 samples. P-values corrected across all contrasts. 
...
# Export file:
#ggsave("output_files/plots/Enrichment/tissue_enrichment.svg",  width = 300, height = 200, units= "mm", a)
